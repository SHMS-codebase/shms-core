...
@Component
@StepScope
public class AppointmentReportEmailTasklet implements Tasklet {

	private static final Logger logger = LogManager.getLogger(AppointmentReportEmailTasklet.class);
	...
	public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) throws Exception {
		...
		logger.info("AppointmentReportEmailTasklet::: execute()");
	...
	private String getReportFilePath(String reportFormat, String formattedNow) {
		...
		logger.info("AppointmentReportEmailTasklet::: getReportFilePath()");

		String baseFilePath = "reports/appointments/appointment_report_" + formattedNow;
		switch (reportFormat) {
		case "pdf":
