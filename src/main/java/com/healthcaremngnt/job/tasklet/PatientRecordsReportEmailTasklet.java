...
@Component
@StepScope
public class PatientRecordsReportEmailTasklet implements Tasklet {

	private static final Logger logger = LogManager.getLogger(PatientRecordsReportEmailTasklet.class);
	...
	public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) throws Exception {
		...
		logger.info("PatientRecordsReportEmailTasklet::: execute()");
	...
	private String getReportFilePath(String reportFormat, String formattedNow) {
		...
		logger.info("PatientRecordsReportEmailTasklet::: getReportFilePath()");

		String baseFilePath = "reports/patients/patient_report_" + formattedNow;
		switch (reportFormat) {
		case "pdf":
