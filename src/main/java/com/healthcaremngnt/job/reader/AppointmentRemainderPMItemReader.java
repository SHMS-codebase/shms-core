...
@Component
@StepScope
public class AppointmentRemainderPMItemReader implements ItemReader<Appointment> {

	private static final Logger logger = LogManager.getLogger(AppointmentRemainderPMItemReader.class);
	...
	public Appointment read()
		...
		logger.info("AppointmentRemainderPMItemReader::: read()");
