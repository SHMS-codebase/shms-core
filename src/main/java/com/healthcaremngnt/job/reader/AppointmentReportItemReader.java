...
@Component
@StepScope
public class AppointmentReportItemReader implements ItemReader<Appointment> {

	private static final Logger logger = LogManager.getLogger(AppointmentReportItemReader.class);
	...
	public Appointment read()
		...
		logger.info("AppointmentReportItemReader::: read()");
