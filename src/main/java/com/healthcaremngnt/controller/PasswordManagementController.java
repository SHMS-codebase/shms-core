...
import com.healthcaremngnt.service.PasswordService;
...
@Controller
@RequestMapping("/api/v1/pwd")
public class PasswordManagementController {

	private static final Logger logger = LogManager.getLogger(PasswordManagementController.class);
	...
	public PasswordManagementController(EmailService emailService, UserService userService,
			PasswordResetService tokenService, PasswordService passwordService) {
